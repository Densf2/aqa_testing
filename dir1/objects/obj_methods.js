...
for (let valueKey in objectValuesPointPlus) {
...
objBasedArays.forEach(function(objBasedArays) {
...
const {selectorHeader: newSelHeader, footerElement: newfooter, linkToHomePage: newLinkH }
 = combinedSelectors
